...
public class ViewHotels extends JFrame implements Runnable{
	...
	ViewHotels(){
		...
		String[] name=new String[] {" Hotel Midtown","Hotel Rishikesh","Hotel Orlov","Hotel Deolives","Hotel karanlake","Hotel Grand plaza","Hotel zoca","Hotel Cosmos","Hotel Gold","Hotel Regency"};
		...
		add(label[i]);
		 ...
		 lname[i]=new JLabel(name[i]);
		lname[i].setBounds(50,500	, 300, 30);
		lname[i].setFont(new Font("Tahoma", Font.BOLD, 35));
